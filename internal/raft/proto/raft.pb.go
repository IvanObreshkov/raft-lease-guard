...
//
// To regenerate Go code, run from the repository root:
//
//   protoc --proto_path=. \
...
//
// If a service is added, install protoc-gen-go-grpc and also pass
// --go-grpc_out=. --go-grpc_opt=paths=source_relative to generate the
...
const file_internal_raft_proto_raft_proto_rawDesc = "" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccessBFZDgithub.com/IvanObreshkov/raft-lease-guard/internal/raft/proto;raftpbb\x06proto3"
